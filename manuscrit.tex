...
En pratique, l'archiviste optera plutôt pour un compromis entre toutes ces méthodes de base. Avec la démocratisation des moteurs de recherches en ligne, l'internaute n'est plus obligé de passer par la front page d'un site pour en consulter le contenu \citep{holscher_web_2000}. Les crawlers doivent donc faire appelle à divers indicateurs topologiques ou sémantiques pour identifier les pages pertinentes à collecter. 
...
On peut avoir des stratégy qui cherche à minimiser cela et à garder la cohérence d'un contenu site (Masanès, 2004) (Castillo et al. 2004; Baeza-Yates and Castillo 2005) saad et al et où l'on va attaquer la front line d'un crawl Mohr et al. (2004) pour l'Heritrix
...
API (github par linkfluence), facebook (example de l'internet archives) rss, vidéo 
