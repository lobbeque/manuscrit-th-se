...
\begin{figure}
  ...
  \caption{Blogosphère marocaine en 2008, la taille des nœuds correspondant à son degré}
  \label{fig:blogs-1}
\end{figure} 
...
\noindent Là on raconte l'état des blogs en 2018

\subsection{Définir l'espace d'exploration}

\noindent Là on explique la forme des fragments que l'on va chercher à retrouver et la stratégie d'exploration

\subsection{Migration d'un territoire Web à un autre}

\noindent Là comprend que les blogs se sont déplacés vers Fb et Twitter

\subsection{Conserver son identité numérique}

\noindent Là on parle de la communauté de chaque blog (caractère diasporique et conservation du public de lecteur)
