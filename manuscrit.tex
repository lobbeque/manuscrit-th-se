...
Mais alors que les institutions semblent s'en détourner, les archives Web trouveronst peut être une forme de continuité dans ce que M. Graham, directeur de la WayBack Machine, nomme les "\textit{rogue archivists}"\footnote{\url{https://youtu.be/33_fnPwaEM0}}. Ce sont des groupes d'activistes et libristes militants \citep{de_kosnik_rogue_2016}, s'inscrivant dans l'héritage d'A. Schwartz\footnote{En 2011, Schwartz télécharge plusieurs millions d'articles scientifiques payants sur le site de l'éditeur JSTOR afin de les rendre accessible au plus grand nombre \url{https://fr.wikipedia.org/wiki/Aaron_Swartz}} et voyant le Web comme un commun de l'Humanité \citep{coriat_retour_2015} à sauvegarder. Ils administrent de manière autonome certains des 7000 crawlers qui alimentent quotidiennement Internet Archive. La trace de ces hacktiviste a été décelée par A. Ben David, qui révèle que les archives du Web Nord Coréen, présentes dans le corpus d'Internet Archive, n'ont pas été collectées par des crawlers institutionnels (bloqués par leur proxy) mais par des crawlers autonomes et indépendants \citep{ben-david_internet_2018}.       
...
1) https://en.wikipedia.org/wiki/Copyright_Directive  Directive 2001/29/EC of the European Parliament and of the Council of 22 May 2001 on the harmonisation of certain aspects of copyright and related rights in the information society
-> Information Society Directive

2) Projet De Loi sur la société de l'information 2001 L. Fabius
adaptation de notre droit aux besoins de la société de l'information

3) projet de loi relatif au  droit d’auteur et aux droits voisins  dans la  société de l’information 2006 (reprise de 1 & 2) loi DADVSI
...
l’obligation de dépôt légal dès lors qu’ils sont mis à disposition
d’un public par la diffusion d’un support matériel, quelle que
...
mais ça avait déjà commencé avant 2006

4) Lancée de manière expérimentale dès février 2009, la collecte des sites web dans le cadre du dépôt légal du web couvre plus de 14 000 sites web français.

5) Le décret du 19 décembre 2011, organisant le dépôt légal du web, est venu en application de la loi du 1er août 2006
...
la BNF fait un crawl anuel de tous les .fr, l'ina qui dispose d'une équipe r&d fait du quotidien.
Il est possible de consulter les archives à la BNF ou dans des biblio spécialisées 
