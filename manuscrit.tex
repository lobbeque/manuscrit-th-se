...
\subsection{Faire se rapprocher les machines}
...
Le Web en 89 au CERN par berners Lee, (ref), libérer au grand public en 92
une système applicatif fonctionnant sur l'internet (couche application)
Le Web est un système hypertext permetant l'accès à des documents (pages) rattachés à des unités plus générale (site), les documents sont liés entre eux par des liens hypertext
Il utilise le protocole HTTP qui permet à un serveur de servir un document hypertetxe et à client de le lire. 
On navigue dans le Web de lien en lien à travers un navigateur (brawoser)

puis moteurs de recherche yahoo -> google
Puis flux de syndicatiosn et réseaux sociaux puis 
Web mobile 



Internet était nait sur les principes fondateurs de l'Arpanent 

Qui appelle naturellement le Web


théorise pour la première fois le passage de l'ère des calculs par ordinateur à celle de la communication par machine interposées. Les travaux de nous permettent ainsi de remonter à la source du rêve imaginé par Licklider, enticipant les transformations 

Faire communiquer des machines entres elles, le réseau au service de la circulation de l'information plutôt que de la mutualisation des forces de calcules. 

Le premier point est de trouver un vocabuaire commun, un protocole de communication entre machines, à cette époque seule scertaines université dispose de grosses bécannes 

le rêve e les faire communiquer 

Le Web s'inscrit dans la longue histoire de l'informatique et des systèmes gravitant autour des machines programmables.


 partant des premiers métiers à tisser programmables au début du XIXe siècle, à la machine analytique de Babbage (1834), en passant par la machine de Turing (1936).  



wesh \\

Le Web est un espace numérique addossé au Réel, et qui s'inscrit dans la longue histoire de l'informatique.
Des canuts à turing les machines automatisées et programables ne cesse de s'améliorér accompagnant la révolution indius
le monde fermé de la guerre froide et les intranet (arpa et autres) ver sle mond eouvert poste URSS et le Web
Les miliataire veulent des réseaux fermés et les scientifiques veulent ouvrir des champs d'expressions 
Un projet en particulier incarne ce paradoxe ou ces tirraillements diplomatico scientifique, le projet Arpa d'abord initié par la naza (p174) p233 raconter dans le bouquin
Request for comment (RFC)
p245 communautéss en ligne
Le Web p259 TCPI IP CERN
p383 outllage numérique des mouvemnts sociaux, les hacker vs monopole d'état et des FAI

\noindent Ici on parle des origines du Web, de sa genèse et des premières communautés en ligne.
De la thèse de truc (environ p150)là on retourne aux prémisses de l'informatique  
c'est quoi le Web, c'est quoi un site Web, c'est quoi un réseau de site, les réseaux sociaux ...

puis le Web passe vers un modèle en silo avant de tourner plus récement vers un modèle de bulles de perceptions 
