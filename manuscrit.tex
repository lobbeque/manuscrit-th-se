...
\title{\nohyphenation{Explorer les archives web pour suivre les traces num\'{e}riques des migrations}}
\cleardoublepage
  {  
  \begin{fullwidth}%
  \thispagestyle{empty}
  \par\noindent \allcaps{\textbf{Universit\'{e} Paris-Saclay}} 
  \par\noindent \'{E}cole doctorale des sciences et technologies de l'information et de la communication 
  \par\noindent Th\`{e}se pour l'obtention du doctorat de T\'{e}l\'{e}com ParisTech et de l'Universit\'{e} Paris-Saclay
  \setlength{\parskip}{\baselineskip}  
  \par\noindent Pr\'{e}sent\'{e}e par : \fontsize{10}{20}{\allcaps{\textbf{\thanklessauthor}}}%
  \vspace{11.5pc}%
  \begingroup
  \fontsize{20}{60}\par\noindent\allcaps{\textbf{\thanklesstitle}}%
  \endgroup
  \vfill%
  ...
  \par\noindent\smallcaps{Th\`{e}se pr\'{e}sent\'{e}e et soutenue} publiquement \`{a} Paris le ??? novembre 2018, devant un jury compos\'{e} de :\\
