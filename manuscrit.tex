...
Afin de déterminer des pistes de réponse, nous construisons, pour terminer, une interface d'exploration dont l'objectif est de tracer des ponts (Figure \ref{fig:calm-match}, arcs bleus) entre le texte de chaque intervention à France Inter (Figure \ref{fig:calm-match}, partie gauche) et les déclarations de motivations des accueillants (Figure \ref{fig:calm-match}, partie droite), telles que nous les découvrons dans la base de données.
