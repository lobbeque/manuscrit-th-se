...
\noindent En 2002, \textit{yabiladi.com} inaugure sa section forum\footnote{\url{https://web.archive.org/web/20020615201721/http://www.yabiladi.com:80/forum/list.php?f=4}} contenant quatre espaces de discussions \textit{Général}, \textit{Femmes marocaines}, \textit{Investir au Maroc} et \textit{La corruption}. Il se présente alors comme le "\textit{Le premier portail destiné aux Marocains Résidant à l'Etranger (RME)!}" mettant en avant un annuaire complet et éditorialisé (classement par catégories) d'adresses Web marocaines\footnote{\url{https://web.archive.org/web/20020531015840/http://www.yabiladi.com:80/}}. 

En suivant le fil des évolutions de \textit{yabiladi.com}, c'est l'histoire du Web dans son intégralité que nous pouvons revivre. Avant 2005, le site est maintenu par sa propre équipe de développeurs PHP, puis, en 2006, un premier CMS est utilisé pour le forum\footnote{\url{https://web.archive.org/web/20070406192841/http://www.phorum.org:80}} et des éléments dynamiques de Javascript sont intégrés en 2010. Les flux RSS\footnote{\url{https://web.archive.org/web/20051217073725/http://www.yabiladi.com:80/rubrik/rss.php}} sont ajoutés dès 2005 mais disparaissent 5 années plus tard; le search hiérarchique (à la Yahoo) est remplacé en 2007 par un search plein texte (à la Google). Il faut attendre 2012 pour voir une redirection se faire vers les comptes Twitter et Facebook de \textit{yabiladi.com} et patienter jusqu'en 2014 pour pouvoir partager du contenu sur les réseaux sociaux. Des technologies maisons sont testées puis abandonnées au profit de solutions extérieurs : un service de chat \textit{Yabuzz}, un player radio\footnote{\url{https://web.archive.org/web/20060717190039/http://www.yabiladi.com:80/radio/download.php}} et une plateforme de partage vidéo \textit{Babrio}\footnote{\url{http://babrio.com/
}}.

À plusieurs reprises, le portail tente de proposer du contenu éditorialisé en complément de ses seuls articles Web. Une Web radio, une Web télé et une Web série\footnote{\url{https://web.archive.org/web/20081220014828/http://www.yabiladi.com:80/webserie/}, \url{https://web.archive.org/web/20101202113409/http://yabiladi.com/tv/}, \url{https://web.archive.org/web/20050411011853/http://www.yabiladi.com:80/radio/}} sont lancées. Deux magazines sont publiés : le premier, un journal satirique et politique\footnote{\url{https://web.archive.org/web/20050831073003/http://www.yabiladi.com:80/magazine/}}, durera 2 ans; le second plus orienté business et tourisme\footnote{\url{https://web.archive.org/web/20101118010916/http://www.yabiladi.com:80/mag}} sera édité pendant 4 années. 

Le site essaye même de faire sortir ses visiteurs du Web pour les faire se rencontrer, non plus dans un espace informatique dédié\footnote{\url{https://web.archive.org/web/20030626013657/http://www.yabiladi.com:80/rencontres/}}, mais dans le monde réel, autour de cafés débats\footnote{\url{https://web.archive.org/web/20060209041225/http://www.yabiladi.com:80/cafe-debat.php}}. Mais, comme une tendance générale, les espaces de débats et d'analyses\footnote{\url{https://web.archive.org/web/20050711003647/http://www.yabiladi.com:80/sommaire-debat.html}}, présents à l'origine du site, finissent par disparaitre et être remplacés par des thématiques plus généralistes, moins porteuses d'opinion : \textit{Divertissement}, \textit{Vie pratique}, \textit{Famille}, ...  

Au final, après 16 années d'existence, \textit{yabiladi.com} reste un portail de référence pour la communauté des marocains de l'étranger, accueillant chaque jour, sur son forum, plusieurs centaines de nouveaux messages, portant tout autant sur la vie de famille, que sur la religion ou les actualité marocaines et internationales. Dans la suite de cette exploration, nous nous concentrerons sur ce seul espace forum\footnote{\url{https://www.yabiladi.com/forum/}} et sur l'ensemble des échanges qui sont quotidiennement réalisés. 
