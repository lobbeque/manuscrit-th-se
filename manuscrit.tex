...
\item Peastee\footnote{\url{https://github.com/lobbeque/peastee}} : interface de visualisation d'archives Web (Javascript, HTML) 
\end{itemize}
...
Dire qu'il existe des manières d'améliorer la thèse, car nous avons voulu, aller coute que coute au bout d'une exploration afin de montrer un exemple complet d'analyse, de manière volontariste, à la manière d'une étude pilote. Revenir au social, revenir à la donnée historique, ne pas se satisfaire des seules données.

 Aussi il reste beaucoup de chose à faire et à améliorer. Tout d'abord sur des aspects purement techniques, même si passer la première année à dévelloper un moteur a permis de gagner du temps en dernière année, nous aurions pu dès le début partir sur des séries de scripts ou autre, des choses plus désagrégées, mais sans ça nous n'aurions peut être jamais eu l'idée de penser le fragment Web.

Il aurait été intéressante aussi de proposer un modèle plus ambicieux de gestion de la cohérence et des artéfactes de crawl, non plus du point de vue du crawleur, comme c'est le cas actuelement mais du point de vue des observateurs, l'ajouter à la définition et dans son extension au fragment Web. De vrais indicateurs de cohérence (structurelle, temporelle, ...). pousser plus avant l'idée de cohérence par rapport à une requête. Pareil pour un critère de bonne datation.

De la même manière, la méthode d'extraction des fragments gagne ici à être confronter et comparée à d'autres, même si nous soutenons que chacun doit être capable (et c'est le but du truc) de proposer sa propre méthode, il est toujours bon d'avoir des éléments de comparaison. 

L'étude sur les blogs gagnerait à utiliser et à interroger les noeud d'expréssion contenus dans les fragments Web pour essayer de questionner le gain sémiologique ou congnitife du passage d'un territoire du Web à l'autre. Et de la même manière l'étude sur le forum pourrait être enrichie en ajoutant d'une part des analyse sur le language et sur le contenu ainsi que des travaux sur les pour et contre M20F.

Enfin, même s'il est dur d'avoir du recul sur un travail en court, dans le chapitre 6 il y a un vrai exemple de statistique confirmatoire vs exploration, les kmeans on confirmé ce que nous savions déjà, du obvious et au final les trouvailles n'arrivent que sur la fin, lorsque nous reprenons vraiment une volonté d'exploration.

au delà de cette thèse serait maintenant d'épprouver les méthodes, de les tester à grande échelle, sur d'autres sujets, essayer de rationnaliser là où il faut, préserver la diversité et l'artisanal, là où ça doit rester. 

Partant de là nous terminions sur la volonté de penser au délà des archives, et au delà pour nous reviens déjà à penser le Web tel qu'il est aujourd'hui, et avec ce truc anxieux que nous ne pourrons peut être plus longtemps archiver car : les bules. Le problème c'est que l'exploration des archives de demain pourrait être bien pauvre ... Le Web fait face à des strétégies indus qui l'appauvrice et le détruise impactant par rebont les archives. La personnification du Web et la gouvernance marchande du Web fait disparaitre l'architecture commune, les Gafa n'étant seulement attirer que part certaines traces (Cardon). Comment prendre en compte la personnalisation du Web pour les archives, pour les crawlers ? Et que penser de l'archivage du Web des appli mobiles, nous passons déjà à côté d'un grand pan du Web. 

Exploiter les archives c'est aussi peut être lutter à notre manière contre l'appauvrisseement du Web qui tend à standardiser les traces pour l'usage des seuls algo, et participer d'une forme de reprise en main collective du Web. Proposer des traces humaines, définis par des chercheurs, qui face ressortir la multitude et la singularité de chacun. Favoriser la diversité. Lafragment est issu de la perseption humaine vs la perceptrion robotique. 

Au final qu'avons nous apris, quelle est l'expérience acquise ? Faire émerger un savoir faire, une forme d'artisana. d'abord il faut faire du mélange humain/machine et être souple, mettre véritablement les mains dans les données, le Web est qqch d'obscure, sale et sauvage, profond, il faut éprouver le Web. Puis ne pas hésiter à proposer des méthodes adaptées à chaque époque du Web, à chaque technologie, à chaque langue, à chaque objet.  Peut être mettre travailler depuis le présent tout en se rendant anachrnique à son propre temps (d'un pt de vue technique mais aussi scientifique)


Mais le fragment ne doit pas être pris comme une solution miracle, il faut toujours aller de paire avec les outils déjà éxistants, ne rien jeter, tout est bon à être utiliser et tout peut être porteur d'un sens qui dans l'immédiat ou dans 10 ans saura faire sens (cf les blogs) 

Ce savoir faire appelle sans hésitation à la création d'une communauté d'explorateurs d'archives, fédérer les corpus, les décrire, ... Nous avons la chance d'être contemporain de la création des archives, il faut donc se saisir de ces dernières, ne pas les sanctuariser, et faire remonter les soucis du côté des archivistes. Ouvrir le débat sur les archives et sensibiliser les citoyen à l'usage de leurs traces.

Ne pas faire n'importe quoi de notre côté, savoir annonymiser, protéger, aggréger voir détruire quand il faut, un grand pouvoir impliqu ede grandes responsabilités.

Il faut savoir créer des outils qui n'abime pas les archives originales, comme pour les grottes, conserver une partie du terrain encore innexplorer pour les suivants et ne pas penser que ce que l'on dit a valeur d'évangile. Mais de toute façon le gateau est assez grand. On peut aussi se dire que d'autres formes d'archives existent et doivent être interconnectée (chercher les fichiers jar cachés dans des clés usb), il faut travailler les connecteurs, les ponts entre les sources, les croisements. Se connecter à d'autres sources de données, y compris vivantes. Car l'histoire est faite de discontinuités.

Il faut comprendre dans quelle temporalité on se situe, de quoi voyons nous le reflet, à combien de rebond sommes nous de notre véritable cible. Y a il des décallages, des erreures de datation

Savoir ce qu'il manque est aussi l'un des enjeux, traquer les fantômes dans les archives, les artéfacts de présence, les puits de gravité. 

Cette thèse, nous l'espérons, saura ouvrir des possibles pour qui souhaite faire du Web et de ses archives des objets d'études historiques à part entière. En ouvrant des brèches dans les corpus du Web passé, en les fragmentant, nous cherchons ici à établir les prémisses dune future archéologie du Web. Quelles bases pour une archéologie du Web. Car l'idée c'est ça, c'est que l'exploration fasse place auxx chantier de fouilles à venir.
