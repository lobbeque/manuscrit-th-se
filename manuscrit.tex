...
\begin{figure*}
  \includegraphics[width=\linewidth]{graphics/front-logo}
\end{figure*}   
  \begingroup
...
\begin{figure*}
  \includegraphics[width=\linewidth]{graphics/front}
\end{figure*}   
...
\begin{fullwidth}
\hspace*{10em}Couverture : \textit{De la Terre à la Lune} (détail), G. Méliès (1930)\\
