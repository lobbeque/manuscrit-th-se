...
\noindent Où l'on parle d'exploration de blogs, de forum et de moments pivots \\

\section{Qu'est ce que l'analyse exploratoire ?}
\label{sec:6_eda}

La montée des stats confirmatoires a 19eme a appelé un retour au réel

\subsection{À la recherche de l'étonnement}

Tukey et la philosophie de l'EDA

\subsection{Observer, découvrir et représenter}

l'EDA c'est être comme un détective ... Ginstzburg
1er schéma de l'eda
Fry, Bertin et Bostock
2nd schéma de fry
...
\noindent Là on présente l'état des blogs en 2008
