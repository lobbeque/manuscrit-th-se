...
Dans notre imaginaire, le Web rime avec immédiateté : il est possible d'accéder à tout et à tout instant. Sous le régime d'un perpétuel présent, le Web se déploie ainsi à perte de vue et se laisse découvrir en continu. Mais, derrière la masse de données quotidiennement générées par et sur la toile, se dissimule pourtant un passé balbutiant qui ne demande qu'à être exploré. 
...
Et s'il semble ambitieux de vouloir retracer ici l'ensemble des mutations du Web et les transformations qu'il a induite au devenir de nos sociétés, nous pouvons  néanmoins nous focaliser sur un problème plus générique : définir les modalités techniques et méthodologiques d'une analyse à grande échelle d'un corpus d'archives Web, susceptible de retracer l'histoire en ligne et hors ligne d'un événement donné. Ce faisant et partant de ce moule, d'autres pourront, après nous, affiner et adapter notre approche suivant leurs propres questions de recherche. Comment rendre compte, au présent, d’un événement et de sa genèse en le restituant dans la double temporalité du Web et du réel ? \\

\noindent Mais, les enjeux soulevés par l'exploration des archives du Web dépassent bien souvent le cadre stricte d'une seule et unique discipline. Pour interroger l'histoire du Web passé, il ne faudra pas hésiter à croiser les regards, les perspectives de recherches, les stratégies et à s'ouvrir aux controverses. Aussi, la présente thèse se situera à la frontière entre l'informatique, l'histoire et la sociologie. 
...
Pour ce faire, nous nous inscrirons dans l'héritage d'un travail pionnier : l'Atlas e-Diasporas \citep{diminescu_e-diasporas_2012}. Ayant su, en son temps, mobiliser ingénieurs, sociologues et historiens autour de l'étude des formes de représentation en ligne des diasporas, l'Atlas a permis l'observation et la cartographie de plus de 9000 sites Web migrants\footnote{\url{http://www.e-diasporas.fr/}}. Crées et maintenus par des personnes migrantes, ces sites se connectaient les uns aux autres par des liens de citation hypertextes formant ainsi de véritables réseaux : soit des collectifs migrants en ligne qui s'organisaient d'abord et avant tout sur le Web. Mais, devant faire face à la disparition totale ou partielle de tout ou partie de ces sites, il a rapidement été décidé de les archiver pendant quatre années durant (de manière hebdomadaire ou mensuelle), et ce, afin de permettre la tenue de recherches futures. C'est ainsi que les archives Web de l'Atlas e-Diasporas se présentent aujourd'hui à nous comme source principale de données sur lesquelles déployer les réflexions de cette thèse et c'est à travers l'angle particulier des usages et des activités en ligne des populations migrantes que nous chercherons à les explorer. 
...
Au chapitre 2 nous parlerons du Web et de ses origines en remontant jusqu'à l'arpanaent pour comprendre d'où viennent les traces que nous nous apprétons à étudier et nous reviendrons sur les liens entre Web et migrations, l'usage particulier et l'intéret académique pour cette nouvelles ousrce de données

Au chaptre 3 nous introduirons la source même de notre travail l'archive, et essayerons de comprendre pourquoi nous ne faisons rien avec elle et comprendrons que notre quête de parler du Web d'un point de vue historique ne sera pas aussi straitforward et il nous faudra predre un détour par des réflexion de structures et de temporalité. les archives sont des coffre fort vitrines batie sur le niveau des pages Webs 

Le Web passé, celui des archives n'est déjà plus le Web et dans le chapitre 4 nous comprendrons se qui différencie le Web archivé du Web vivant. UN Web discrétisé à la temporalité figées, cela pause des questions de cohérence ... et nous cehrcherons à les intégrer (point ingénierie) à un moteur de recherche maison. Néanmoisn les archives ne sont pas les traces directes du Web mais les traces des outils de collectes, robots crawler ...  

CHapitre 5 Aussi nous proposerons comme principale contribution l'introduction d'une nouvelles entité le fragment Web ... pour une exploration désagrégée des archievs Web, qui permette de faire du montage et de retrouver de la souplesse, les crawl legacy seront alors revu par rapport à ce nouveau modèle pour aussi retrouver une plus grande précision historique

Chapitre 6 Puis nous plogerons dans les archives et mènerons 2 explorations consécutives, à la tuckey qui est de toute façon transversal à toute la thèse. Cela sera le moment d'appliquer les fragments Web pour compredre d'une part le déevenir es blogs et d'autre part l'embrasement d'ub formur en ligne au moemnt des printemps arabes. Ce sera aussi le moment de parler de moment pivots pivits deu Web et de ce que toute cela peut faire d'un point de vue historiographique

Chaitre 7 enfin, le truc c'est que les archives Web ne sont pas les seules formes d'enregistrement de la mémoire de la toile et que d'autre traces peuvent être explorée pour saisir d'autre aspect du lien qui unis Web et migration. Le sujet sur la BPI sera l'occase de repenser le Web en tant qu'environnement (dans les aordie et or des ordi, 'intégrant à la bibliot). LE sujet sur Calm sera l'occasion de parler des bases de données des migrations et de revenir sur la crise des réfuggiesr ...

Allant au casse pipe cette thèse puorra sembler fragile par sa volonté de tout vouloir traiter, mais c'est le sujet qui en a voulu ainsi et l'important c'est qu'elle ouvre des possibles tant sur l'étude des migration, que sur l'analyse histo des archives que son exploration large et scalable.
